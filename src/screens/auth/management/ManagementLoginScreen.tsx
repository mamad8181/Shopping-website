...
export const ManagementLoginScreen = () => {
  const { handleSubmit, adminLoginFormHandler, register, errors, loading } = useAdminLogin()

  return (
    <div className='py-16' >
        <form className='w-2/6 border-2 m-auto' onSubmit={handleSubmit(adminLoginFormHandler)}>
            ...
            <Button className='bg-black text-white rounded-full w-full mt-7' loading={loading} ><p>ورود</p></Button>
            </div>
        </form>
    </div>
  )
