...
export const StoreManagement = () => {
  ...
  return (
    <div className='p-10 pt-16 relative' >
      ...
      <div className='w-3/4 px-20 py-10 border-2 border-black rounded-3xl m-auto mt-10'>
        <p>کنترل لیبل بالای فروشگاه:</p>
        <TextField className='border-2 rounded-full mt-3 mb-5 w-1/2 px-1.5 outline-none py-1' />
        <p>پس از اجرا:</p>
